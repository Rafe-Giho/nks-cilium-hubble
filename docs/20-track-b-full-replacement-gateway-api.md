...
이 트랙은 Cilium full replacement가 필요합니다. CNI migration 자체는 `docs/10-track-a-full-replacement-ingress.md`의 0~7단계를 그대로 사용합니다.
...
아직 Cilium primary CNI로 전환하지 않았다면 먼저 아래 문서의 0~7단계를 완료합니다.
