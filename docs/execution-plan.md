...
| 3. 구성 초안 설계 | Calico chaining, Hubble Relay/UI/CLI, Hubble metrics/exporter, Cilium Service Mesh 옵션 선정 | 번호형 실행 가이드와 `service-mesh/` 문서 정리 |
...
4. Cilium Service Mesh 검증 결과와 현재 NKS 적용 불가 사유를 `docs/service-mesh/05-build-result-report.md`에 유지합니다.
5. Cilium primary 기반 Service Mesh 표준 가이드는 `docs/service-mesh/01-cilium-service-mesh-runbook.md`에 분리합니다.
