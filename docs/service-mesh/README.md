...
구축 가이드와 기술 설명에는 Hubble 관측 계층을 포함하지만, 운영 무게 비교 문서에서는 순수 Cilium Service Mesh와 Istio Ambient만 비교합니다.
...
| `01-cilium-service-mesh-runbook.md` | Cilium primary 기반 Service Mesh 표준 실행 절차 |
| `02-validation-checklist.md` | 적용 전후 검증 항목 |
| `03-cilium-service-mesh-concepts.md` | Cilium Service Mesh 개념, 구성요소, 현재 NKS 적용 의미 |
| `04-operational-weight-comparison.md` | 순수 Cilium Service Mesh와 Istio Ambient 운영 무게 비교 |
